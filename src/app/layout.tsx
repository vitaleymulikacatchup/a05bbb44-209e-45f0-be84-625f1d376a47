...
export const metadata: Metadata = {
  title: "Luxe Stay | Luxury Hotel & Resort",
  description: "Experience world-class hospitality at Luxe Stay. Luxury rooms, fine dining, spa, and premium amenities for the perfect getaway.",
  keywords: "luxury hotel, resort, accommodation, fine dining, spa, vacation",
  ...
  openGraph: {
    title: "Luxe Stay | Luxury Hotel & Resort",
    description: "Book your luxury stay with us. Premium rooms, amenities, and exceptional service.",
    siteName: "Luxe Stay",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763983783725-4trhu7yx.jpg",
      alt: "Luxe Stay Hotel"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Luxe Stay | Your Luxury Destination",
    description: "Discover premium accommodations and world-class service",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763983783725-4trhu7yx.jpg"]
  }
};
